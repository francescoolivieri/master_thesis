...
def default_checkpoint_manifest() -> list[CheckpointSpec]:
    ...
    return [
        ...
        CheckpointSpec("update/value/bTah_Vh_det", "update", "Safety values on deterministic rollout", update_atol, update_rtol),
        CheckpointSpec("update/value/bTp1ah_Vh_det", "update", "Bootstrapped Vh values on deterministic rollout", update_atol, update_rtol),
        CheckpointSpec("update/gae/bTah_Qh", "update", "GAE safety targets", update_atol, update_rtol),
        CheckpointSpec("update/gae/bTah_Qh_det", "update", "GAE safety targets for deterministic rollout", update_atol, update_rtol),
        ...
        CheckpointSpec("update/metrics/policy_grad_norm", "update", "Logged policy grad norm", update_atol, update_rtol),
        ...
        CheckpointSpec("update/param_delta/policy", "update", "L2 norm of policy parameter delta", update_atol, update_rtol),
